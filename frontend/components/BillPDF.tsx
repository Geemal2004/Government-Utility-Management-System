...
const BillPDF: React.FC<BillPDFProps> = ({ bill }) => {
  ...
  const subtotalBeforeDeductions = bill.billDetails.reduce((sum, item) => sum + item.amount, 0) + bill.fixedCharge;
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          <View style={styles.headerTop}>
            <View style={styles.companyInfo}>
              <Text style={styles.companyName}>Government Utility Services</Text>
          ...
          <View style={styles.infoGrid}>
            ...
            <View style={styles.infoColumn}>
              ...
              <View style={styles.infoRow}>
                ...
                <View style={[
                  styles.statusBadge,
                  isPaid ? styles.statusPaid : isOverdue ? styles.statusOverdue : styles.statusUnpaid
                ]}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.infoRow}>
            ...
            <Text style={styles.infoValue}>{bill.serviceConnection.address}</Text>
          </View>
        </View>
          ...
          <View style={styles.infoGrid}>
            ...
            <View style={styles.infoColumn}>
              <View style={styles.infoRow}>
                ...
                <Text style={styles.infoValue}>{bill.serviceConnection.utilityType}</Text>
              </View>
              <View style={styles.infoRow}>
                <Text style={styles.infoLabel}>Tariff Category:</Text>
                <Text style={styles.infoValue}>{bill.serviceConnection.tariffCategory}</Text>
              </View>
            </View>
          </View>
        </View>
          ...
          <View style={styles.table}>
            <View style={styles.tableHeader}>
              ...
              <View style={styles.tableCol}>
                <Text style={[styles.tableColHeader, styles.tableCellRight]}>Previous</Text>
              </View>
              <View style={styles.tableCol}>
                <Text style={[styles.tableColHeader, styles.tableCellRight]}>Current</Text>
              </View>
              <View style={styles.tableCol}>
                <Text style={[styles.tableColHeader, styles.tableCellRight]}>Consumption</Text>
              </View>
            </View>
            ...
            <View style={[styles.tableRow, styles.tableRowAlt]}>
              ...
              <View style={styles.tableCol}>
                <Text style={[styles.tableCell, styles.tableCellRight]}>
                  {new Date(bill.consumption.previousReadingDate).toLocaleDateString()}
                </Text>
              </View>
              <View style={styles.tableCol}>
                <Text style={[styles.tableCell, styles.tableCellRight]}>
                  {new Date(bill.consumption.currentReadingDate).toLocaleDateString()}
                </Text>
              </View>
              <View style={styles.tableCol}>
            ...
            {bill.consumption.exportUnits && bill.consumption.exportUnits > 0 && (
              <View style={styles.tableRow}>
                ...
                <View style={styles.tableCol}>
                  <Text style={[styles.tableCell, styles.tableCellRight, { color: '#15803d' }]}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.chargesTable}>
            ...
            {bill.billDetails.map((detail, index) => (
              <View key={index} style={[styles.chargeRow, styles.chargeRowIndent, index % 2 === 0 ? styles.tableRowAlt : {}]}>
                <Text style={styles.chargeLabel}>
                  {detail.slabRange} @ {formatCurrency(detail.ratePerUnit)}/unit
                  {' '}({detail.units.toFixed(3)} units)
                </Text>
                <Text style={styles.chargeAmount}>{formatCurrency(detail.amount)}</Text>
              </View>
            ))}
            ...
            <View style={[styles.chargeRow, styles.tableRowAlt]}>
              ...
              <Text style={styles.chargeAmount}>{formatCurrency(bill.fixedCharge)}</Text>
            </View>

            {/* Subtotal */}
            <View style={[styles.chargeRow, { borderTopWidth: 1, borderTopColor: '#d1d5db', marginTop: 5 }]}>
            ...
            {bill.solarCredit && bill.solarCredit > 0 && (
              <View style={styles.chargeRow}>
                <Text style={[styles.chargeLabel, { color: '#15803d' }]}>
                  Solar Export Credit ({bill.consumption.exportUnits?.toFixed(3)} units)
                </Text>
                <Text style={[styles.chargeAmount, { color: '#15803d' }]}>
            ...
            {bill.taxes.map((tax, index) => (
              <View key={index} style={styles.chargeRow}>
                ...
                <Text style={styles.chargeAmount}>{formatCurrency(tax.taxAmount)}</Text>
              </View>
            ))}
            ...
            <View style={styles.chargeRowTotal}>
              ...
              <Text style={styles.chargeAmountBold}>{formatCurrency(bill.totalAmount)}</Text>
            </View>
          </View>
        </View>
        ...
        {isPaid && bill.payments && bill.payments.length > 0 ? (
          <View style={styles.section}>
            <View style={styles.paymentBox}>
              ...
              {bill.payments.map((payment, index) => (
                <View key={index}>
                  <View style={styles.infoRow}>
                    <Text style={[styles.infoLabel, { color: '#15803d' }]}>Payment Date:</Text>
                    <Text style={[styles.infoValue, { color: '#15803d' }]}>
                      {formatDate(payment.paymentDate)}
                    </Text>
                  </View>
                  <View style={styles.infoRow}>
                    <Text style={[styles.infoLabel, { color: '#15803d' }]}>Payment Method:</Text>
                    <Text style={[styles.infoValue, { color: '#15803d' }]}>
                      {payment.paymentMethod}
                    </Text>
                  </View>
                  <View style={styles.infoRow}>
                    <Text style={[styles.infoLabel, { color: '#15803d' }]}>Amount:</Text>
                    <Text style={[styles.infoValue, { color: '#15803d' }]}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.infoGrid}>
              <View style={styles.infoColumn}>
                <Text style={[styles.chargeLabel, styles.tableCellBold, { marginBottom: 3 }]}>
                  Online Payment:
                </Text>
                <Text style={styles.chargeLabel}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.notesBox}>
            <Text style={styles.noteText}>
              • Payment must be received by the due date to avoid late payment penalties.
            </Text>
            <Text style={styles.noteText}>
              • A penalty of 2% per month will be charged on overdue amounts.
            </Text>
            <Text style={styles.noteText}>
              • Service may be disconnected if payment is not received within 30 days of due date.
            </Text>
            <Text style={styles.noteText}>
              • For billing inquiries or disputes, contact our customer service within 7 days.
            </Text>
            <Text style={styles.noteText}>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>
            ...
            Terms and conditions apply. Visit www.govutility.lk/terms for details.{'\n'}
            Page 1 of 1
          </Text>
        </View>
      </Page>
